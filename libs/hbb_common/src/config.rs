...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.elodatacenter.com.br"];
pub const RS_PUB_KEY: &str = "Qfi0zaxpUOiV1bsFUZ6hXOnBVUTZHco50M1h3dDF3QyQmQilFa44WZK50MjRUViojI5V2aiwiIiojIpBXYiwiIyJmLt92YuIXZ05WZjFGdhR2bsVmLrNXZkR3c1JnI6ISehxWZyJCLiInYu02bj5iclRnblNWY0FGZvxWZus2clRGdzVnciojI0N3boJye";
...
impl Config {
    ...
    pub fn get_option(k: &str) -> String {
        if k == keys::OPTION_CUSTOM_RENDEZVOUS_SERVER {
            return "rustdesk.elodatacenter.com.br".to_owned();
        }
        if k == keys::OPTION_RELAY_SERVER {
            return "rustdesk.elodatacenter.com.br".to_owned();
        }
        if k == keys::OPTION_KEY {
            return "Qfi0zaxpUOiV1bsFUZ6hXOnBVUTZHco50M1h3dDF3QyQmQilFa44WZK50MjRUViojI5V2aiwiIiojIpBXYiwiIyJmLt92YuIXZ05WZjFGdhR2bsVmLrNXZkR3c1JnI6ISehxWZyJCLiInYu02bj5iclRnblNWY0FGZvxWZus2clRGdzVnciojI0N3boJye".to_owned();
        }
        get_or(
            &OVERWRITE_SETTINGS,
